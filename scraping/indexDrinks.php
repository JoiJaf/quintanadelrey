...
$link = "https://www.allrecipes.com/recipes/242/drinks/sangria/";
...
//      file_put_contents("../img/sangria-" .$image. ".jpg", file_get_contents($images[$index]));
//  }
...
// Reference: https://medoo.in/api/insert
 ...
 for($i=0; $i<16; $i++){
     $database->insert("tb_info_platillo", [
         ...
         "platillo_img" =>  "sangria-".$filenames[$i].".jpg",
         "platillo_catego" =>  "Drinks",
...
//     "categ_descrip" => "This sweet wine punch is packed with fresh fruit and sometimes spiked with liquor. Find recipes for red wine, white wine, and rosé-based sangrias.",
//     "categ_nombre" =>  "Drinks"
// ]);
